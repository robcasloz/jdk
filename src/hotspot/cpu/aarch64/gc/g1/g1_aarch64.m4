...
// These are fewer than 1% of the total executed stores, no need to define an encode-and-store version.STOREN_INSN(Volatile,stlrw)
dnl
define(`CAEP_INSN',
`
// This pattern is generated automatically from g1_aarch64.m4.
...
%{
  ...
  ins_encode %{
    ...
    g1_pre_write_barrier(masm, this,
                         ...
                         $tmp3$$Register /* tmp2 */,
                         RegSet::of($mem$$Register, $preval$$Register, $newval$$Register) /* preserve */);
    __ $2($preval$$Register, $newval$$Register, $mem$$Register);
  ...
  ins_pipe(pipe_serial);
%}')dnl
XCHGN_INSN(,atomic_xchgw)
XCHGN_INSN(Acq,atomic_xchgalw)
dnl
define(`LOADP_INSN',
`
// This pattern is generated automatically from g1_aarch64.m4.
