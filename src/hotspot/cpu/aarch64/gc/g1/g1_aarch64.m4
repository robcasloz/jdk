...
%{
  ...
  ins_encode %{
    G1BarrierSetC2::dump_node_info(this, false, false);
...
%{
  predicate(UseG1GC && !needs_releasing_store(n) && n->as_Store()->barrier_data() != 0 && UseEncodeAndStore);
...
%{
  ...
  ins_encode %{
    G1BarrierSetC2::dump_node_info(this, true, false);
