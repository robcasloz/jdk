...
class G1BarrierSetAssembler: public ModRefBarrierSetAssembler {
 ...
 public:
  ...
  Register imprecise_marking_address_via_address(const MachNode* node, const Address obj) const;
  Register imprecise_marking_address_via_type(const MachNode* node) const;
