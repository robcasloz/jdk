...
class LibraryCallKit : public GraphKit {
 ...
 private:
  ...
  void copy_to_clone_array(Node* obj, Node* alloc_obj, int header_size, Node* length, int elem_size);
  void copy_to_clone_instance(Node* obj, Node* alloc_obj, Node* obj_size);
