...
public:
  ...
  bool has_barrier_flag(uint16_t data) const { return ((_barrier & data) != 0); }
...
class BarrierRecord : public ArenaObj {
public:
  MachNode* _access;
  Node*     _mem;
...
public:
  ...
  MachSafePointNode() : MachReturnNode(), _oop_map(nullptr), _jvms(nullptr), _jvmadj(0), _has_ea_local_in_scope(false), _barrier_records(NULL) {
