...
void Parse::call_register_finalizer() {
  ...
  Node* klass;
  if (UseNewCode) {
    klass = _gvn.transform(LoadKlassNode::make(_gvn, nullptr, immutable_memory(), receiver, TypeInstPtr::BOTTOM, TypeInstKlassPtr::OBJECT));
  } else {
    Node* klass_addr = basic_plus_adr( receiver, receiver, oopDesc::klass_offset_in_bytes() );
    klass = _gvn.transform(LoadKlassNode::make(_gvn, nullptr, immutable_memory(), klass_addr, TypeInstPtr::KLASS));
  }
