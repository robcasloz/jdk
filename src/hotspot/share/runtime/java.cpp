...
public:
  ...
  unsigned long long _total_store_volatile;
  unsigned long long _total_store_encode;
  unsigned long long _total_store_nopost;
  unsigned long long _total_store_notnull;
  unsigned long long _total_store_imprecise;
  unsigned long long _total_store_imprecise_candidate;
  ...
  CollectG1BarrierStatsClosure() :
    ...
    _total_store_imprecise(0),
    _total_store_imprecise_candidate(0),
    _total_atomic(0),
    _total_load(0),
    _total_pre_entry(0),
  ...
  void do_thread(Thread* thread) {
    ...
    _total_store_volatile += javaThread->_total_store_volatile;
    ...
    _total_store_imprecise += javaThread->_total_store_imprecise;
    _total_store_imprecise_candidate += javaThread->_total_store_imprecise_candidate;
...
void print_statistics() {
  ...
  if (G1ProfileBarriers || G1ProfileBarrierTests) {
    ...
    tty->print_cr("g1-barrier-stats,%d.%06d,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld,%lld",
                  ...
                  cl._total_store_imprecise, cl._total_store_imprecise_candidate,
